  ...
  $.fn.plusGallery = function(options){
    ...
    var pg = {
      ...
      init: function(){
        ...
        // share facebook
        _doc.on("click", ".btn-share", function() {
          var url = $(this).attr('data-url_share_facebook');
          var title = $(this).attr('data-title');
          pg.popUpShare(url, title);
          return false;
        });
      ...
      parseData: function(json,title){
        ...
        $.each(objPath,function(i,obj){
          ...
          if(i < pg.limit) {
            ...
            case 'flickr':
              imgTitle = obj.title;
              urlDetail = 'https://www.flickr.com/photos/'+pg.userId+'/'+obj.id+'/';
              urlShareFacebook = 'https://www.facebook.com/sharer/sharer.php?u='+urlDetail;
            ...
            pg.shareFacebookArray[i] = urlShareFacebook;

            $('#pgthumbs').append('<div class="pgthumb col-xs-12 col-sm-4 col-md-3 col-lg-3 frame"><div class="box"><a href="' + imgSrc + '"><img src="' + imgTh + '" id="pgthumbimg' + i + '" class="pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '></a></div></div>');
      ...
      loadZoom: function(idx){
        ...
        pgZoomView.fadeIn(function(){
          ...
          $.each(pg.imgArray,function(i){
            ...
            pgZoomHTML = pgZoomHTML  + '<li class="pgzoomslide loading" id="pgzoomslide' + i + '" style="width: ' + pg.winWidth + 'px;"><img src="' + pg.imagePath + '/square.gif" class="pgzoomspacer"><div class="share"><button type="button" class="btn btn-default btn-share" data-url_share_facebook="'+pg.shareFacebookArray[idx]+'" data-title="'+pg.titleArray[idx]+'">Share</button></div><span class="pgzoomcaption">' + pg.titleArray[i] + '</span></li>';
